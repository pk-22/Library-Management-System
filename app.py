...
app.config['MYSQL_PASSWORD'] = 'Prashant#22'
    ...
    if request.method == 'POST':
        ...
        if title == "" and author == "" and genre == "" and isbn == "":
            ...
            if author == "" and genre == "" and isbn == "":
                ...
                query = "SELECT ISBN, title, author, year_of_publication, genre, shelf_Id FROM book where title LIKE '%{}%' and isbn LIKE '%{}%' ".format(title,isbn) 
                cur.execute(query)
                result = cur.fetchall()
            elif author == "" and genre != "" and isbn == "":
                ...
                query = "SELECT ISBN, title, author, year_of_publication, genre, shelf_Id FROM book where title LIKE '%{}%' and genre LIKE '%{}%' and isbn LIKE '%{}%' ".format(title,genre,isbn) 
                cur.execute(query)
                result = cur.fetchall()
            elif author != "" and genre == "" and isbn == "":
                ...
                query = "SELECT ISBN, title, author, year_of_publication, genre, shelf_Id FROM book where title LIKE '%{}%' and author LIKE '%{}%' and isbn LIKE '%{}%' ".format(title,author,isbn) 
                cur.execute(query)
                result = cur.fetchall()
            elif author != "" and genre != "" and isbn == "":
                ...
                query = "SELECT ISBN, title, author, year_of_publication, shelf_Id, genre FROM book where title LIKE '%{}%' and author LIKE '%{}%' and genre LIKE '%{}%' and isbn LIKE '%{}%' ".format(title,author,genre,isbn) 
                cur.execute(query)
                result = cur.fetchall()
            ...
            if genre == "" and isbn == "":
                ...
                query = "SELECT ISBN, title, author, year_of_publication, genre, shelf_Id FROM book where author LIKE '%{}%' and isbn LIKE '%{}%' ".format(author,isbn) 
                cur.execute(query)
                result = cur.fetchall()
            elif genre != "" and isbn == "":
                ...
                query = "SELECT ISBN, title, author, year_of_publication, genre, shelf_Id FROM book where genre LIKE '%{}%' and author LIKE '%{}%' and isbn LIKE '%{}%' ".format(genre,author,isbn) 
                cur.execute(query)
                result = cur.fetchall()

        elif title == "" and author == "":
            if genre == "" and isbn != "":
                query = "SELECT ISBN, title, author, year_of_publication, genre, shelf_Id FROM book where isbn LIKE '%{}%'".format(isbn)
                cur.execute(query)
                result = cur.fetchall()
            elif genre != "" and isbn == "":
                ...
                query = "SELECT ISBN, title, author, year_of_publication, genre, shelf_Id FROM book where isbn LIKE '%{}%' and genre LIKE '%{}%' ".format(isbn,genre) 
                cur.execute(query)
                result = cur.fetchall()
        mysql.connection.commit()
        cur.close()
